...
in
{
  ...
  programs.bash.shellAliases = {
    ...
    cloneall=''
      pushd . > /dev/null ;
      cd ${repos_path} ;
      git clone git@github.com:tanner-johnson2718/PI_JTAG_DBGR.git ;
      git clone git@github.com:tanner-johnson2718/Ricks_Designs.git ;
      git clone git@github.com:tanner-johnson2718/Calc_N_Phys.git ;
      git clone git@github.com:tanner-johnson2718/Crypto.git ;
	    git clone git@github.com:tanner-johnson2718/env.git ;
      git clone git@github.com:tanner-johnson2718/C_Ref.git ;
      popd> /dev/null ;
    '';
  };
