...
[0] = LAYOUT_65_ansi_blocker(
 ...
 KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_GRV,            KC_UP,    KC_PGDN,
 KC_LCTL,  KC_LGUI,  KC_LALT,                                KC_SPC,                                 KC_RSFT,  KC_PSCR,    KC_LEFT,  KC_DOWN,  KC_RGHT
 ),
